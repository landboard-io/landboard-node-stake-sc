...
deploy() {
    ...
    --pem=${WALLET} \
    --gas-limit=100000000 \
    --arguments ${TOKEN_ID_HEX} ${TOKEN_ID_HEX} ${REFERRRAL_ACTIVATION_AMOUNT} ${APY_INCREASE_PER_REFERRAL} ${MAX_APY_INCREASE_BY_REFERRAL} ${REFERRAL_REWARD} ${PROMO_INCREASE_APY} \
    --send \
    --metadata-payable \
